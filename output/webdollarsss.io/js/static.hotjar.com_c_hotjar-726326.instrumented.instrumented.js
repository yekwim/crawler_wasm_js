...
window.hjSiteSettings = window.hjSiteSettings || {
    ...
    'cs_project_id': null,
    'account_id': 318347,
    'account_signature': '26806c0a9243e5f34f57df62112a2c90d365ca02f94fe95164366a87ee4b7cb4'
};
!function () {
    'use strict';
    function e(t) {
    ...
    var n, i = function () {
            function e(t) {
                var r = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : 10, n = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : 1000;
                !function (e, t) {
                    if (!(e instanceof t))
    ...
    var o, s = function () {
            ...
            var t = !1, r = 'v='.concat(u.version), n = ''.concat(u.metricsUrl, '?').concat(r, '&site_id=').concat(window.hjSiteSettings.site_id) + (c.isDebugEnabled ? '&debug=true' : ''), i = JSON.stringify(e);
            ...
            if (!1 === t)
                try {
                    ...
                    a.open('POST', n), a.timeout = 10000, a.send(i);
                } catch (e) {
                }
            ...
            start: function () {
                try {
                    ...
                    var e = p.time(), t = window.hjSiteSettings || {}, r = t.features, n = t.site_id, a = new Set(r), l = u.sampling;
                    return c.genericTags = { site_id: n }, c.isDebugEnabled = Math.random() <= l.universalDebug || a.has('client_script.metrics.debug') && Math.random() <= l.debug, c.isMetricsEnabled = Math.random() <= l.metrics, c.isFieldMetricsEnabled = c.isMetricsEnabled && Math.random() <= l.fieldMetrics, o = new i(h, u.buffer.bufferSize, u.buffer.flushInterval), e;
                } catch (e) {
            ...
            count: function (e, t) {
                ...
                try {
                    var u, l = d(n), h = c.loggedMetrics[e], p = 0;
            ...
            timeIncr: function (e, t) {
                var r, n, i, a, o = t.tag, s = t.start, u = t.flush, g = t.extraTags, f = t.type, h = hj.metrics.time(), m = s && h ? h - s : void 0, v = (r = e, {
                        tagName: n = d(o),
                        start: (a = (i = c.loggedMetrics[r]) && i[n] || {}).start,
                        total: a.total
                    }), w = m ? m + (v.total || 0) : v.total;
                return l(e, v.tagName, { total: w }), u && p.timeEnd(e, {
                    tag: o,
                    total: w,
                    extraTags: g,
                    type: f
    ...
    if (window.hjLazyModules = window.hjLazyModules || {
            SURVEY_V2: { js: 'survey-v2.85b23977c07ec2f68c07.js' },
            ...
            SURVEY_INVITATION: { js: 'survey-invitation.9d04a0f4661aee0febb5.js' },
            ...
            USER_TEST: { js: 'user-test.32c39d7ef6563de15c54.js' }
        }, X)
        window._uxa.push([
            'start:hotjar',
        ...
        var W = (k = (I = window.hjSiteSettings).suppress_all || I.suppress_text || (null === (x = I.suppress_all_on_specific_pages) || void 0 === x ? void 0 : x.length), U = function (e) {
                ...
                CS_CONF_BASE: {
                    ...
                    voc: null !== (N = I.polls) && void 0 !== N && N.length || (V = null !== (z = function () {
                        ...
                        if ('string' == typeof e && function (e) {
                                if ('string' != typeof e)
                                    return !1;
                                try {
                                    var t = new URL(e), r = '1' === t.searchParams.get('is_preview');
                    ...
                    }(), H = void 0 !== V, q = null !== y.get(), H && y.set({ referrer: V }), q || H) ? {
                        enabled: 1,
                        siteId: I.site_id
                    } : { enabled: 0 },
            ...
            }), K = W.CS_CONF_BASE, Q = W.PII_SELECTORS;
        window.CS_CONF_BASE = K, window._uxa = window._uxa || [], Q && window._uxa.push([
            'setPIISelectors',
            { PIISelectors: Q }
        ]);
        var $ = window._hjSettings.environment, G = 't.contentsquare.net';
        ...
        window.hjBootstrap = window.hjBootstrap || function (e, t, r) {
            ...
            if (i.test(a))
                return hj.metrics.count('session-rejection', { tag: { reason: 'bot' } }), void console.warn('Hotjar not launching due to suspicious userAgent:', a);
            var o = 'http:' === window.location.protocol, s = Boolean(window._hjSettings.preview);
            if (o && !s)
                return hj.metrics.count('session-rejection', { tag: { reason: 'https' } }), void console.warn('For security reasons, Hotjar only works over HTTPS. Learn more: https://help.hotjar.com/hc/en-us/articles/115011624047');
            ...
            u(0, 0, r);
            var c = window.document, l = c.head || c.getElementsByTagName('head')[0];
            hj.scriptDomain = e;
            var d = c.createElement('script');
            d.async = 1, d.src = hj.scriptDomain + t, d.charset = 'utf-8', l.appendChild(d), u.revision = 'effc4f1', window.hjBootstrap = u;
        }, window.hjBootstrap('https://script.hotjar.com/', 'modules.79484904679daf64371c.js', '726326'), hj.metrics.timeEnd('resource-blocking-time', {
...
!function () {
    try {
        ...
        n && (e._sentryDebugIds = e._sentryDebugIds || {}, e._sentryDebugIds[n] = '91c5d1d9-4804-5c64-9fa3-713809783000');
    } catch (e) {
    }
}();
__instrumentation__.capture('WebSocket', 'call_1759369828316_62j4fiouq', 1759369828316);
__instrumentation__.capture('WebSocket', 'call_1759369828316_3vyksjbi5', 1759369828316);
__instrumentation__.capture('WebSocket', 'call_1759369844350_d64umep6z', 1759369844350);
__instrumentation__.capture('WebSocket', 'call_1759369844350_syn8cvnsj', 1759369844350);