                ...
                var S = function () {
                        ...
                        function H(y, L) {
                            ...
                            if (n = C.$(T.container || x.container), o = T.hasOwnProperty('duration') ? T.duration : x.duration, a = T.hasOwnProperty('lazy') ? T.lazy : x.lazy, r = T.easing || x.easing, i = T.hasOwnProperty('offset') ? T.offset : x.offset, l = T.hasOwnProperty('force') ? !1 !== T.force : x.force, u = T.hasOwnProperty('cancelable') ? !1 !== T.cancelable : x.cancelable, c = T.onStart || x.onStart, s = T.onDone || x.onDone, f = T.onCancel || x.onCancel, d = void 0 === T.x ? x.x : T.x, p = void 0 === T.y ? x.y : T.y, 'function' == typeof i && (i = i(t, n)), v = z(n), m = V(n), M(), S = !1, !l) {
                                var k = 'body' === n.tagName.toLowerCase() ? document.documentElement.clientHeight || window.innerHeight : n.offsetHeight, $ = m, A = $ + k, q = w - i, F = q + t.offsetHeight;
                                if (q >= $ && F <= A)
                                    return void (s && s(t));
                            }
                            if (c && c(t), O || g)
                                return 'string' == typeof r && (r = b[r] || b.ease), P = h.apply(h, r), C.on(n, _, D, { passive: !0 }), window.requestAnimationFrame(j), function () {
                                    E = null, S = !0;
                                };
                            s && s(t);
                        }
...
__instrumentation__.capture('WebSocket', 'call_1759369825221_62u178gzi', 1759369825222);
__instrumentation__.capture('WebSocket', 'call_1759369825222_y0m2ufowp', 1759369825222);
__instrumentation__.capture('WebSocket', 'call_1759369825222_jdtlah8lq', 1759369825222);
__instrumentation__.capture('WebSocket', 'call_1759369834549_0ypdytrwa', 1759369834549);
__instrumentation__.capture('WebSocket', 'call_1759369834550_al3k7933v', 1759369834550);
__instrumentation__.capture('WebSocket', 'call_1759369834550_j86144yzd', 1759369834550);