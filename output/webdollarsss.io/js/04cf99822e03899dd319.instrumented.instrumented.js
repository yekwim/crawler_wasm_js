...
(self.webpackChunk_webdollar_front_webdollar = self.webpackChunk_webdollar_front_webdollar || []).push([
    [407],
    {
        8424: function (e, t, i) {
            ...
            var a = { name: 'FooterLayout' }, s = (0, i(1900).Z)(a, function () {
                    var e = this, t = e.$createElement, i = e._self._c || t;
                    return i('div', { attrs: { id: 'footer' } }, [i('div', { attrs: { id: 'footerSection' } }, [i('div', { staticClass: 'textContainer sectionCenteredWidth' }, [
                                i('div', { staticClass: 'footerContainer' }, [
                                    i('div', [
                                        i('h2', [e._v(e._s(e.$i18n.t('layout.footer.followUs')))]),
                                        e._v(' '),
                                        e._m(0)
                                    ]),
                                    e._v(' '),
                                    i('div', [
                                        i('h2', [e._v(e._s(e.$i18n.t('layout.footer.poweredBy')))]),
                                        e._v(' '),
                                        e._m(1),
                                        e._v(' '),
                                        e._m(2)
                                ...
                                e._v(' '),
                                i('div', { staticClass: 'newCryptoText' }, [e._v(e._s(e.$i18n.t('layout.footer.footer')))])
                            ])])]);
                }, [
                    function () {
                        var e = this, t = e.$createElement, i = e._self._c || t;
                        return i('div', { staticClass: 'footerItem followUsLinks' }, [
                            i('a', {
                    ...
                    function () {
                        var e = this, t = e.$createElement, i = e._self._c || t;
                        return i('div', { staticClass: 'footerItem' }, [
                            i('a', {
                                attrs: {
                            ...
                            e._v(' '),
                            i('span', { staticClass: 'newCryptoText' }, [e._v('BitTechnologies')])
                        ]);
                    },
                    function () {
                        var e = this, t = e.$createElement, i = e._self._c || t;
                        return i('div', { staticClass: 'footerItem' }, [
                            ...
                            e._v(' '),
                            i('span', { staticClass: 'newCryptoText' }, [e._v('AIPSS')])
                        ]);
                    }
        ...
        5392: function (e, t, i) {
            ...
            var a = {
                    ...
                    name: 'HeaderLayout',
                    components: {
                        LanguageSelect: (0, s.Z)(a, function () {
                            var e = this, t = e.$createElement, i = e._self._c || t;
                            return i('div', { staticClass: 'language-select' }, [i('div', { staticClass: 'sl-nav' }, [i('ul', [i('li', [
                                            i('i', { class: 'sl-flag flag-' + e.getSelected.short }),
                                            e._v(' '),
                                            i('b', [e._v(e._s(e.getSelected.text))]),
                                            e._v(' '),
                                            i('div', { staticClass: 'triangle' }),
                                            e._v(' '),
                                            i('ul', e._l(e.languages, function (t, a) {
                                                return i('li', {
                                                    key: a,
                                                    on: {
                                                        click: function (i) {
                                                    ...
                                                    i('i', { class: 'sl-flag flag flag-' + t.short }),
                                                    e._v(' '),
                                                    i('span', { staticClass: 'active' }, [e._v(e._s(t.text))])
                                                ]);
                                            }), 0)
                                        ])])])]);
                    ...
                    methods: {
                        ...
                        addEvent: function (e, t, i) {
                            null != e && (e.addEventListener ? e.addEventListener(t, i, !1) : e.attachEvent ? e.attachEvent('on' + t, i) : e['on' + t] = i);
                        }
                    },
                    mounted: function () {
                        var e = this;
                    ...
                    return i('div', {
                        ...
                        i('div', {
                            ...
                            }, [i('language-select', { staticClass: 'nav-link' })], 1),
                            e._v(' '),
                            i('a', {
                                class: this.mobileMenuOpened && this.isMobile ? 'openedMenuLink' : '',
                                attrs: {
                            ...
                            }, [i('div', { on: { click: this.collapseMenuBack } }, [e._v(e._s(e.$i18n.t('layout.navbar.explorer')))])]),
                            e._v(' '),
                            i('router-link', {
                                class: this.mobileMenuOpened && this.isMobile ? 'openedMenuLink' : '',
                                attrs: { to: '/partners/businesses' }
                            }, [i('div', { on: { click: this.collapseMenuBack } }, [e._v(e._s(e.$i18n.t('layout.navbar.partners')))])]),
                            e._v(' '),
                            i('router-link', {
                                class: this.mobileMenuOpened && this.isMobile ? 'openedMenuLink' : '',
                                attrs: { to: '/partners/exchanges' }
                            }, [i('div', { on: { click: this.collapseMenuBack } }, [e._v(e._s(e.$i18n.t('layout.navbar.exchanges')))])]),
                            e._v(' '),
                            i('router-link', {
                                class: this.mobileMenuOpened && this.isMobile ? 'openedMenuLink' : '',
                                attrs: { to: '/faq' }
                            }, [i('div', { on: { click: this.collapseMenuBack } }, [e._v(e._s(e.$i18n.t('layout.navbar.faq')))])]),
                            e._v(' '),
                            i('router-link', {
                                class: this.mobileMenuOpened && this.isMobile ? 'openedMenuLink' : '',
                                attrs: { to: '/media' }
                            }, [i('div', { on: { click: this.collapseMenuBack } }, [e._v(e._s(e.$i18n.t('layout.navbar.media')))])]),
                            e._v(' '),
                            i('router-link', {
                                class: this.mobileMenuOpened && this.isMobile ? 'openedMenuLink' : '',
                                attrs: { to: '/#community' }
                            }, [i('div', { on: { click: this.collapseMenuBack } }, [e._v(e._s(e.$i18n.t('layout.navbar.community')))])]),
                            e._v(' '),
                            i('router-link', {
                                class: e.mobileMenuOpened && this.isMobile ? 'openedMenuLink' : '',
                                attrs: { to: '/#coinDistributionSection' }
                            }, [i('div', { on: { click: this.collapseMenuBack } }, [e._v(e._s(e.$i18n.t('layout.navbar.network')))])]),
                            e._v(' '),
                            i('router-link', {
                                class: e.mobileMenuOpened && this.isMobile ? 'openedMenuLink' : '',
                                attrs: { to: '/#get-started' }
                            }, [i('div', { on: { click: this.collapseMenuBack } }, [e._v(e._s(e.$i18n.t('layout.navbar.getStarted')))])]),
                            e._v(' '),
                            i('router-link', {
                                class: e.mobileMenuOpened && this.isMobile ? 'openedMenuLink' : '',
                                attrs: { to: '/#what-is-WebDollar' }
                            }, [i('div', { on: { click: this.collapseMenuBack } }, [e._v(e._s(e.$i18n.t('layout.navbar.about')))])]),
                            e._v(' '),
                            i('a', {
                        ...
                        e._v(' '),
                        i('div', { attrs: { id: 'WebDollarAlertsStickyBar' } })
                    ]);
                }, [], !1, null, null, null).exports;
        },
        3407: function (e, t, i) {
            ...
            var a = i(5392), s = i(8424), l = {
                    ...
                    mounted: function () {
                        ...
                        }), this.changeFullSectionHeight(), document.body.style.backgroundColor = '#000', this.fullHeightSectionOnMobile(document.getElementById('aboutSection'), 768), this.fullHeightSectionOnMobile(document.getElementById('coinDistributionSection'), 768), this.addEvent(window, 'resize', function (t) {
                    ...
                    methods: {
                        changeFullSectionHeight: function () {
                            for (var e = document.getElementsByClassName('fullSection'), t = this.screenHeight - 70, i = 0; i < e.length; i++)
                                e[i].style.height = t + 'px';
                            this.fullHeightSectionOnMobile(document.getElementById('aboutSection'), 768), this.fullHeightSectionOnMobile(document.getElementById('coinDistributionSection'), 768);
                        },
                ...
                }, n = (0, i(1900).Z)(l, function () {
                    var e = this, t = e.$createElement, i = e._self._c || t;
                    return i('div', { staticStyle: { 'overflow-y': 'auto' } }, [
                        i('HeaderLayout'),
                        e._v(' '),
                        e._m(0),
                        e._v(' '),
                        i('div', { attrs: { id: 'websiteBody' } }, [e._t('content')], 2),
                        e._v(' '),
                        i('FooterLayout')
                    ], 1);
                }, [function () {
...
__instrumentation__.capture('WebSocket', 'call_1759369824802_fg1rcftny', 1759369824802);
__instrumentation__.capture('WebSocket', 'call_1759369824802_3gg2q9c8w', 1759369824802);
__instrumentation__.capture('WebSocket', 'call_1759369833625_o8r17wqee', 1759369833626);
__instrumentation__.capture('WebSocket', 'call_1759369833626_5g98722h1', 1759369833626);