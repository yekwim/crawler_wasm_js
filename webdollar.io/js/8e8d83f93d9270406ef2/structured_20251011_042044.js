    ...
    8424: function(e, t, a) {
      ...
      var i = {
        ...
        s = (0, a(1900).Z)(i, (function() {
          ...
          }, [a("div", [a("h2", [e._v(e._s(e.$i18n.t("layout.footer.followUs")))]), e._v(" "), e._m(0)]), e._v(" "), a("div", [a("h2", [e._v(e._s(e.$i18n.t("layout.footer.poweredBy")))]), e._v(" "), e._m(1), e._v(" "), e._m(2)])]), e._v(" "), a("div", {
            staticClass: "newCryptoText"
          }, [e._v(e._s(e.$i18n.t("layout.footer.footer")))])])])])
        }), [function() {
          var e = this,
            t = e.$createElement,
            a = e._self._c || t;
          return a("div", {
            staticClass: "footerItem followUsLinks"
          }, [a("a", {
      ...
      var i = {
          ...
          methods: {
            selectLanguage: function(e) {
              this.$store.dispatch("localizationStoreSelectedLanguage", {
                language: e.short
              })
            }
          }
          ...
          components: {
            LanguageSelect: (0, s.Z)(i, (function() {
              ...
              return a("div", {
                ...
                class: "sl-flag flag-" + e.getSelected.short
              }), e._v(" "), a("b", [e._v(e._s(e.getSelected.text))]), e._v(" "), a("div", {
                staticClass: "triangle"
              }), e._v(" "), a("ul", e._l(e.languages, (function(t, i) {
                return a("li", {
                  key: i,
                  on: {
                    click: function(a) {
                  ...
                  class: "sl-flag flag flag-" + t.short
                }), e._v(" "), a("span", {
                  staticClass: "active"
                }, [e._v(e._s(t.text))])])
              })), 0)])])])])
        ...
        n = (0, s.Z)(l, (function() {
          ...
          return a("div", {
            ...
            on: {
              click: this.handleToggleDark
            }
          }, [a("div", [a("span", {
            class: "fas fa-" + (e.$store.state.settings.dark ? "sun" : "moon") + " nav-item-icon ",
            attrs: {
              title: e.$i18n.t("layout.navbar.switchTheme")
            }
          })])]), e._v(" "), a("a", {
            class: this.mobileMenuOpened && this.isMobile ? "openedMenuLink" : "",
            attrs: {
          ...
          }, [e._v(e._s(e.$i18n.t("layout.navbar.explorer")))])]), e._v(" "), a("router-link", {
            class: this.mobileMenuOpened && this.isMobile ? "openedMenuLink" : "",
            attrs: {
          ...
          }, [e._v(e._s(e.$i18n.t("layout.navbar.partners")))])]), e._v(" "), a("router-link", {
            class: this.mobileMenuOpened && this.isMobile ? "openedMenuLink" : "",
            attrs: {
              to: "/partners/exchanges"
            }
          }, [a("div", {
            on: {
              click: this.collapseMenuBack
            }
          }, [e._v(e._s(e.$i18n.t("layout.navbar.exchanges")))])]), e._v(" "), a("router-link", {
            class: this.mobileMenuOpened && this.isMobile ? "openedMenuLink" : "",
            attrs: {
              to: "/faq"
            }
          ...
          }, [e._v(e._s(e.$i18n.t("layout.navbar.faq")))])]), e._v(" "), a("router-link", {
            class: this.mobileMenuOpened && this.isMobile ? "openedMenuLink" : "",
            attrs: {
              to: "/media"
            }
          ...
          }, [e._v(e._s(e.$i18n.t("layout.navbar.media")))])]), e._v(" "), a("router-link", {
            class: this.mobileMenuOpened && this.isMobile ? "openedMenuLink" : "",
            attrs: {
              to: "/#community"
            }
          ...
          }, [e._v(e._s(e.$i18n.t("layout.navbar.community")))])]), e._v(" "), a("router-link", {
            class: e.mobileMenuOpened && this.isMobile ? "openedMenuLink" : "",
            attrs: {
              to: "/#coinDistributionSection"
            }
          }, [a("div", {
            on: {
              click: this.collapseMenuBack
            }
          }, [e._v(e._s(e.$i18n.t("layout.navbar.network")))])]), e._v(" "), a("router-link", {
            class: e.mobileMenuOpened && this.isMobile ? "openedMenuLink" : "",
            attrs: {
              to: "/#get-started"
            }
          ...
          }, [e._v(e._s(e.$i18n.t("layout.navbar.getStarted")))])]), e._v(" "), a("router-link", {
            class: e.mobileMenuOpened && this.isMobile ? "openedMenuLink" : "",
            attrs: {
              to: "/#what-is-WebDollar"
            }
          }, [a("div", {
            on: {
              click: this.collapseMenuBack
            }
          }, [e._v(e._s(e.$i18n.t("layout.navbar.about")))])]), e._v(" "), a("a", {
            ...
            style: {
              display: e.mobileMenuOpened || 0 == e.isMobile ? "none" : "block"
            },
            attrs: {
              href: "javascript:void(0);"
            },
    ...
    6680: function(e, t, a) {
      ...
      var i = a(5392),
        ...
        l = {
          ...
          methods: {
            changeFullSectionHeight: function() {
              for (var e = document.getElementsByClassName("fullSection"), t = this.screenHeight - 70, a = 0; a < e.length; a++) e[a].style.height = t + "px";
        ...
        n = (0, a(1900).Z)(l, (function() {
          ...
          }, [a("HeaderLayout"), e._v(" "), e._m(0), e._v(" "), a("div", {
            attrs: {
              id: "websiteBody"
            }
          }, [a("div", {
          ...
          }), e._v(" "), e._t("content")], 2), e._v(" "), a("FooterLayout")], 1)
        }), [function() {
          var e = this.$createElement,
            t = this._self._c || e;
          return t("div", {
            staticClass: "backgroundVideoWrap"
          }, [t("video", {
