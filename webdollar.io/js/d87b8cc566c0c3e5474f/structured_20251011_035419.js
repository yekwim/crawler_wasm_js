/*! For license information please see d87b8cc566c0c3e5474f.js.LICENSE.txt */
    ...
    3081: function(e) {
      e.exports = function() {
        ...
        var h = function(e, t, n, r) {
            ...
            if (e === t && n === r) return m;
            for (var a = u ? new Float32Array(i) : new Array(i), c = 0; c < i; ++c) a[c] = d(c * l, e, n);

            function s(t) {
              for (var r = 0, u = 1, c = i - 1; u !== c && a[u] <= t; ++u) r += l;
              --u;
              var s = r + (t - a[u]) / (a[u + 1] - a[u]) * l,
                f = p(s, e, n);
        ...
        var C = {
            ...
            on: function(e, t, n) {
              ...
              for (var r = 0; r < t.length; r++) e.addEventListener(t[r], n, !!w && o)
            },
            off: function(e, t, n) {
              t instanceof Array || (t = [t]);
        ...
        var S = function() {
            var t, n, o, r, a, i, l, u, c, s, f, d, p, v, y, m, w, g, O, S, L, T, E, P, k, $, A, D = function(e) {
              u && (E = e, S = !0)
            };
            ...
            function j(e) {
              if (S) return q();
              k || (k = e), a || M(), $ = e - k, A = Math.min($ / o, 1), A = P(A), F(n, m + O * A, v + g * A), $ < o ? window.requestAnimationFrame(j) : q()
            }

            function q() {
              S || F(n, w, y), k = !1, C.off(n, _, D), S && f && f(E, t), !S && s && s(t)
            }
            ...
            function H(y, L) {
              ...
              if ("object" === e(L) ? T = L : "number" == typeof L && (T.duration = L), !(t = C.$(y))) return console.warn("[vue-scrollto warn]: Trying to scroll to an element that is not on the page: " + y);
              if (n = C.$(T.container || x.container), o = T.hasOwnProperty("duration") ? T.duration : x.duration, a = T.hasOwnProperty("lazy") ? T.lazy : x.lazy, r = T.easing || x.easing, i = T.hasOwnProperty("offset") ? T.offset : x.offset, l = T.hasOwnProperty("force") ? !1 !== T.force : x.force, u = T.hasOwnProperty("cancelable") ? !1 !== T.cancelable : x.cancelable, c = T.onStart || x.onStart, s = T.onDone || x.onDone, f = T.onCancel || x.onCancel, d = void 0 === T.x ? x.x : T.x, p = void 0 === T.y ? x.y : T.y, "function" == typeof i && (i = i(t, n)), v = z(n), m = V(n), M(), S = !1, !l) {
                var k = "body" === n.tagName.toLowerCase() ? document.documentElement.clientHeight || window.innerHeight : n.offsetHeight,
                  $ = m,
                  A = $ + k,
                  q = w - i,
                  F = q + t.offsetHeight;
                if (q >= $ && F <= A) return void(s && s(t))
              }
              if (c && c(t), O || g) return "string" == typeof r && (r = b[r] || b.ease), P = h.apply(h, r), C.on(n, _, D, {
                  passive: !0
        ...
        function $(e) {
          ...
          if (t.value) {
            if (e.preventDefault(), "string" == typeof t.value) return L(t.value);
        ...
        var A = {
          ...
          V = function(e, t) {
            t && O(t), e.directive("scroll-to", D), (e.config.globalProperties || e.prototype).$scrollTo = D.scrollTo
          };
        return "undefined" != typeof window && window.Vue && (window.VueScrollTo = D, window.VueScrollTo.setDefaults = O, window.VueScrollTo.scroller = S, window.Vue.use && window.Vue.use(V)), D.install = V, D
      }()
    }
  }
]);